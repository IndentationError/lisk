...
describe('transport', function () {
	...
	var dbStub, loggerStub, busStub, schemaStub, networkStub, balancesSequenceStub, transactionStub;
	...
	describe('Transport constructor', function () {
		...
		describe('library', function () {
			...
			it('should assign scope variables', function (done) {
				new TransportModule(function () {
